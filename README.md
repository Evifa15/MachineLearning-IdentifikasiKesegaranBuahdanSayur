...
Model ini merupakan sistem identifikasi kesegaran buah dan sayur yang dikembangkan menggunakan teknik *Machine Learning* dengan arsitektur **CNN MobileNetV2** melalui metode ***Transfer Learning***. Sistem ini dirancang untuk memproses input gambar komoditas secara otomatis dan memberikan klasifikasi mengenai nama komoditas serta status kesegarannya (Segar atau Busuk).
## 🚀 Deskripsi Proyek
Sistem ini menggunakan pendekatan *Deep Learning* untuk membedakan kategori buah dan sayur. Prototipe ini telah dilatih menggunakan dataset komprehensif dengan rincian sebagai berikut:
